...
const FOOTER_PRODUCTS = [
  { label: "SBA Loans", href: "/apply" },
  { label: "Equipment Financing", href: "/apply" },
  { label: "Line of Credit", href: "/apply" },
  { label: "Invoice Factoring", href: "/apply" },
  { label: "Invoice Financing", href: "/apply" },
  { label: "Merchant Cash Advance", href: "/apply" },
  { label: "Debt Relief", href: "/apply" },
];
